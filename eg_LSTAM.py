...
def main():
    # load dataset
    series = read_csv('/Users/jeanclaudelemoyne/work/Data/samples/shampoo-sales.csv',
                      header=0, parse_dates=[0], index_col=0, squeeze=True, date_parser=parser)

    print series
    print series.shape
    # feat_transform data to be stationary
    raw_values = series.values
    print 'type raw_value: ', type(raw_values)
